...
A similar module exists (with other debug functions) with Geth-style traces ([`debug`](https://github.com/openibank/creditchain/blob/main/docs/vocs/docs/pages/jsonrpc/debug.mdx)).
