...
What we've arrived at is the [minimal ExEx example](https://github.com/openibank/creditchain-exex-examples/blob/4f3498f0cc00e038d6d8c32cd94fe82788862f49/minimal/src/main.rs) that we provide in the [reth-exex-examples](https://github.com/openibank/creditchain-exex-examples) repository.
