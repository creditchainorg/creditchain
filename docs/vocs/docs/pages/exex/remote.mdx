...
For an example of a full schema, see the [Remote ExEx](https://github.com/openibank/creditchain-exex-examples/blob/1f74410740ac996276a84ee72003f4f9cf041491/remote/proto/exex.proto) example.
...
the [NodeBuilder](https://docs.creditchain.org/docs/reth/builder/struct.NodeBuilder.html)'s [task executor](https://docs.creditchain.org/docs/reth/tasks/struct.TaskExecutor.html).
