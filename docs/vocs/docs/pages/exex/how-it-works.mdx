...
They are installed into the node by using the [node builder](https://docs.creditchain.org/docs/reth/builder/struct.NodeBuilder.html).
Reth manages the lifecycle of all ExExes, including:

-   Polling ExEx futures
-   Sending [notifications](https://docs.creditchain.org/docs/reth_exex/enum.ExExNotification.html) about new chain, reverts,
    and reorgs from historical and live sync
-   Processing [events](https://docs.creditchain.org/docs/reth_exex/enum.ExExEvent.html) emitted by ExExes
...
ExExes **SHOULD** emit an [`ExExEvent::FinishedHeight`](https://docs.creditchain.org/docs/reth_exex/enum.ExExEvent.html#variant.FinishedHeight)
