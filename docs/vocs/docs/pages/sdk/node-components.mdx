...
- [custom-node-components](https://github.com/creditchainorg/creditchain/tree/main/examples/custom-node-components) - Custom transaction pool
- [custom-payload-builder](https://github.com/creditchainorg/creditchain/tree/main/examples/custom-payload-builder) - Custom payload builder
- [custom-evm](https://github.com/creditchainorg/creditchain/tree/main/examples/custom-evm) - Custom EVM configuration
