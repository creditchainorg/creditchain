...
2. Check database integrity:
    ...
    ```
    If `mdbx_chk` has detected any errors, please [open an issue](https://github.com/creditchainorg/creditchain/issues) and post the output from the `mdbx_chk.log` file.
