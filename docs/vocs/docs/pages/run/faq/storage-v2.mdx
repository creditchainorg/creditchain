---
description: Experimental hot/cold storage architecture in CreditChain v1.11.
---
...
but may change in future releases. Please report issues on [GitHub](https://github.com/openibank/creditchain/issues)
or in the [Telegram group](https://t.me/paradigm_reth).
:::

CreditChain v1.11 introduces an experimental hot/cold storage architecture behind the `--storage.v2` flag.
...
[snapshots.creditchain.org](https://snapshots.creditchain.org) and start from there:

```bash
# Download and extract a v2 snapshot (see snapshots.creditchain.org for available options)
creditchaind download --chain mainnet
...
- [v1.11.0 release notes](https://github.com/openibank/creditchain/releases/tag/v1.11.0) — full details on storage v2 and other changes
