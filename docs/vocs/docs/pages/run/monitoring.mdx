...
You can find an example config for the Prometheus service in the repo here: [`etc/prometheus/prometheus.yml`](https://github.com/openibank/creditchain/blob/main/etc/prometheus/prometheus.yml)
...
[docs]: https://github.com/openibank/creditchain/tree/main/docs
