...
-   **GitHub Issues**: [Open an issue](https://github.com/creditchainorg/creditchain/issues/new) for bugs or feature requests
-   **Telegram Chat**: [Join our Telegram](https://t.me/paradigm_reth) for real-time support and discussions

## Repository and Project Structure

Reth is organized as a modular codebase with clear separation and a contributor friendly architecture, you can read about it in detail [here](https://github.com/creditchainorg/creditchain/tree/main/docs). Here's the TL;DR:
...
:::note
Also read [CONTRIBUTING.md](https://github.com/creditchainorg/creditchain/blob/main/CONTRIBUTING.md) for in-depth guidelines.
:::
