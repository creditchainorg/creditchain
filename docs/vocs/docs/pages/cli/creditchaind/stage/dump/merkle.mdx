# creditchaind stage dump merkle

Merkle stage

```bash
$ creditchaind stage dump merkle --help
```
```txt
Usage: creditchaind stage dump merkle [OPTIONS] --output-datadir <OUTPUT_PATH> --from <FROM> --to <TO>
