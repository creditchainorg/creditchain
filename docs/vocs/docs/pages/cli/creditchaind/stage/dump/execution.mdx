# creditchaind stage dump execution

Execution stage

```bash
$ creditchaind stage dump execution --help
```
```txt
Usage: creditchaind stage dump execution [OPTIONS] --output-datadir <OUTPUT_PATH> --from <FROM> --to <TO>
