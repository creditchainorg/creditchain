# creditchaind stage dump account-hashing

`AccountHashing` stage

```bash
$ creditchaind stage dump account-hashing --help
```
```txt
Usage: creditchaind stage dump account-hashing [OPTIONS] --output-datadir <OUTPUT_PATH> --from <FROM> --to <TO>
