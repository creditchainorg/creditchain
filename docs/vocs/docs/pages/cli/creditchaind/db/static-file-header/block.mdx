# creditchaind db static-file-header block

Query by segment and block number

```bash
$ creditchaind db static-file-header block --help
```
```txt
Usage: creditchaind db static-file-header block [OPTIONS] <SEGMENT> <BLOCK>
