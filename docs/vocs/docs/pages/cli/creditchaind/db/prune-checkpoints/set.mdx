# creditchaind db prune-checkpoints set

Set a prune checkpoint for a segment.

```bash
$ creditchaind db prune-checkpoints set --help
```
```txt
Usage: creditchaind db prune-checkpoints set [OPTIONS] --segment <SEGMENT> --mode <MODE>
