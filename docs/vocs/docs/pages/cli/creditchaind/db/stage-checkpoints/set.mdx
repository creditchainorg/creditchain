# creditchaind db stage-checkpoints set

Set a stage checkpoint

```bash
$ creditchaind db stage-checkpoints set --help
```
```txt
Usage: creditchaind db stage-checkpoints set [OPTIONS] --stage <STAGE> --block-number <BLOCK_NUMBER>
