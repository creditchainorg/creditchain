# creditchaind download

Download public node snapshots

```bash
$ creditchaind download --help
```
```txt
Usage: creditchaind download [OPTIONS]
...
Storage:
  ...
  -u, --url <URL>
          ...
          Browse available snapshots at https://snapshots.creditchain.org
          or use --list-snapshots to see them from the CLI.

          Available snapshot sources:
          - https://snapshots.creditchain.org (default)
