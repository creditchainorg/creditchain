# CreditChain Genesis Files

Copyright (c) CreditChain Research Team.

These genesis files define the first CreditChain environment set:
...
process finalizes chain registry metadata. Keep EVM semantics compatible and
run genesis changes through release review before publishing a new environment.
